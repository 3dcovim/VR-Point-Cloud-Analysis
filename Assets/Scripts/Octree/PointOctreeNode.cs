...
public class PointOctreeNode<T> {
	...
	const int NUM_OBJECTS_ALLOWED = 1; //Cambiado para que se reduzcan al maximo los nodos últimos
	...
	public class OctreeObject {
		...
		public override bool Equals(object obj)
		{
			...
			{
				OctreeObject p = (OctreeObject)obj;
				bool equals = p.Pos.Equals(this.Pos);
				return equals;
			}
		}
