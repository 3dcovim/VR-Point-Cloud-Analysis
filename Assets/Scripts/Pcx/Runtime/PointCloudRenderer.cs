...
namespace Pcx
{
    ...
    public sealed class PointCloudRenderer : MonoBehaviour
    {
        ...
        [SerializeField]
        PointCloudDataExtended _sourceDataExt = null;


        public PointCloudDataExtended sourceDataExt
        {
            get { return _sourceDataExt; }
            set { _sourceDataExt = value; }
        }

        [SerializeField] int _sourceDataProps = 0;
        public int sourceDataProps
        {
            get { return _sourceDataProps; }
            set { _sourceDataProps = value; }
        }
